...
export const BANK_TXS: DemoBankTx[] = [
  {
    ...
    status: "auto", matchTier: "rf", matchExplain: "Référence RF, rapprochement déterministe. Montant à l'ancien loyer : écart d'indexation détecté, ordre permanent pas à jour (manque 70,00 €).",
    matchedLeaseId: "l-3b",
  },
  {
  ...
  },
  {
    ...
    status: "review", matchExplain: "Tiers payeur (aide au logement), candidat Studio RDC à 0,71. Lier l'IBAN CNAP automatisera les mois suivants.",
  },
  {
    ...
    status: "auto", matchTier: "fuzzy", matchExplain: "Score 0,86 : IBAN connu + nom. Paiement partiel alloué en FIFO, reliquat ouvert (préavis en cours).",
    matchedLeaseId: "l-1a",
  },
  {
