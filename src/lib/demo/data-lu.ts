...
export const PROPERTIES: DemoProperty[] = overlay(fr.PROPERTIES, {
  ...
  "p-bertrange": {
    ...
    ownershipNote: "Marie-Josée a Pierre Kieffer, 50/50, kollektiv Besteierung",
  },
  "p-kirchberg": {
...
export const BANK_TXS: DemoBankTx[] = overlay(fr.BANK_TXS, {
  "tx-01": {
    ...
    matchExplain:
      "RF-Referenz, deterministescht Rapprochement. Betrag zum ale Loyer: Indexatiouns-Ecart erkannt, Daueroptrag net aktualiséiert (et feelen 70,00 €).",
  },
  "tx-02": {
  ...
  "tx-05": {
    ...
    matchExplain:
      "Drëttbezueler (Wunnhëllef), Kandidat Studio Rez op 0,71. CNAP-IBAN verbanne wäert déi nächst Méint automatiséieren.",
  },
  "tx-06": {
    counterpartyName: "C KREMER",
    remittanceInfo: "Loyer August partiell, Solde no Regularisatioun",
    matchExplain: "Score 0,86: bekannten IBAN + Numm. Deelzuelung a FIFO alloziert, Rescht op (Preavis am Gaang).",
  },
  "tx-07": {
...
export const TICKETS: DemoTicket[] = overlay(fr.TICKETS, {
  ...
  "t-5": {
    ...
    rechargeDecision: { decision: "owner", note: "Vetusté a Remise en état tëscht zwee Locatairen: Charge Proprietär." },
  },
});
...
export const WORKFLOWS: DemoWorkflow[] = overlay(fr.WORKFLOWS, {
  ...
  "wf-4": {
    ...
    blockedReason: "1 Ofzuch ouni Justificatif, leeft de 15/07 of (duerno forclos)",
  },
